  ...
  return {
    nodes: [
      ...
      section('bbz-Award (0.5 · schriftlich + 0.5 · mündlich)', [grid(r.award)], {
        intro: 'Rangliste je Profil über Zertifizierungsvorgänge; nur Vorgänge mit bestandener mündlicher Prüfung. Eine Person mit mehreren Profilen erscheint je Profil mit dem jeweiligen Vorgang. Tie-Break 1: weniger Prüfungsversuche gesamt, Tie-Break 2: früheres Referenzdatum. Versuchsmodus: ' + (ctx.modeLabel || ctx.mode) + '.',
      }),
